...
m=FaissManager()
m.vectoriser=QwenVectoriser(model="Alibaba-NLP/gte-Qwen2-1.5B-instruct", trust_remote=True, left_side_padding=False)
m.create_index_from_strings(docs, list(range(len(docs))))
m.save_index('../indices/gte-Qwen2_1-5b.index')
